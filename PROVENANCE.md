...
| Test and build tooling | 9,480 lines across 39 files (`tools/`, `desktop/`) |
...
| | |
|---|---|
| Headless checks | 1026 across 16 suites, about six seconds, downloads nothing |
...
| Security checks | 83, which run attacks rather than assert outcomes |
