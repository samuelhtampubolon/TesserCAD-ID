...
| | |
|---|---|
| Application source | 24,902 lines across 56 modules (`src/`) |
| Test and build tooling | 9,397 lines across 39 files (`tools/`, `desktop/`) |
...
| | |
|---|---|
| Headless checks | 1010 across 16 suites, about six seconds, downloads nothing |
