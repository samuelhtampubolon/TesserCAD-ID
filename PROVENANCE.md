...
| | |
|---|---|
| Application source | 24,918 lines across 56 modules (`src/`) |
| Test and build tooling | 9,405 lines across 39 files (`tools/`, `desktop/`) |
...
| | |
|---|---|
| Headless checks | 1012 across 16 suites, about six seconds, downloads nothing |
