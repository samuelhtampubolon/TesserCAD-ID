...
whole feature — 220 of the 1012 headless checks — be tested without a browser,
...
| Time to first test run | `npm test`, about six seconds, downloads nothing |
...
| Test checks | 1012 headless in 16 suites, plus the browser suites and the desktop shell |
