...
export const PROCESSES = {
  fdm: {
    ...
    scrap: 0.15,
    wants: ['overhang di bawah 45 derajat', 'tanpa jembatan tanpa penyangga di atas 10mm'],
    note: 'Cara termurah memegang part hari ini juga; garis layer dan ikatan Z yang lemah membuatnya proses prototipe, bukan produksi.',
  },
  sla: {
    label: 'Resin (SLA/DLP)',
    kind: 'additive',
    ...
    scrap: 0.25,
    wants: ['lubang tiris di setiap rongga', 'tanpa rongga tertutup penuh'],
    note: 'Detail halus dan permukaan mulus, tetapi partnya getas dan rusak kena sinar matahari.',
  },
  sls: {
    label: 'Nilon SLS',
    kind: 'additive',
    ...
    scrap: 0.35,
    wants: ['lubang keluar untuk bubuk yang tidak tersinter'],
    note: 'Tanpa struktur penyangga, jadi geometri nyaris gratis; hamparan bubuk membuat batch kecil masuk akal saat cetakan tidak.',
  },
  cnc3: {
    label: 'CNC 3 sumbu',
    kind: 'subtractive',
    ...
    scrap: 0.1,
    wants: ['sudut dalam dengan radius', 'fitur yang terjangkau dari satu sisi'],
    note: 'Anda membayar material yang dibuang dan setiap setup tambahan, jadi part yang dikerjakan dari satu sisi berbiaya sebagian kecil dari yang tidak.',
  },
  sheet: {
    label: 'Pelat potong laser',
    kind: 'subtractive',
    ...
    scrap: 0.2,
    wants: ['constant thickness', 'tekukan tidak lebih rapat dari tebal material'],
    note: 'Jauh proses logam termurah, tetapi hanya untuk part yang memang benar-benar pelat terlipat.',
  },
  cast: {
    label: 'Cor pasir',
    kind: 'formative',
    ...
    scrap: 0.3,
    wants: ['tebal dinding seragam', 'draft pada setiap muka tegak', 'generous fillets'],
    note: 'Murah per kilogram pada volume besar; pola dan permukaan kasar membuatnya jarang menjadi part jadi.',
  },
  im: {
    label: 'Cetak injeksi',
    kind: 'formative',
