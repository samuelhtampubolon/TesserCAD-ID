...
export const QUALITY = {
  draft: { label: 'Draft', tol: 0.25, note: 'Lihat cepat, berkas kecil. Faset terlihat pada lubang kecil.' },
  standard: { label: 'Standar', tol: 0.05, note: 'Yang dibutuhkan sebagian besar cetak 3D dan visualisasi.' },
  fine: { label: 'Halus', tol: 0.01, note: 'Mulus dari dekat dan untuk setup permesinan. Berkas lebih besar.' },
  source: { label: 'Sesuai model', tol: null, note: 'Berapa pun jumlah segmen yang sudah dibawa fitur.' },
};
