...
s = await page.evaluate(async () => {
  ...
  // PNG finishes asynchronously, so it is awaited rather than measured on
  // the next line like the others.
  //
...
check('the bill of materials exports too', s.bom > 100, `bom ${s.bom} B`);
